...
export class dayEdit extends AbstractComponent {
  ...
  getTemplate(){
    ...
    <form class="event  event--edit" action="#" method="post">
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--destination">
          ...
          <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${this._towns}" list="destination-list-1">
    ...
    return `<div class="event__offer-selector">
      <input class="event__offer-checkbox  visually-hidden" id="event-offer-luggage-1" type="checkbox" name="event-offer-luggage" ${it.availability ? `checked` : ``}>
        ...
        <section class="event__section  event__section--destination">
          ...
          <p class="event__destination-description">${this._description.map((it) => { return `${it}`; }).slice(0, 3).join(``)}</p>

          <div class="event__photos-container">
            <div class="event__photos-tape">
              ${this._photos.map((it) => { return `<img class="event__photo" src="${it}" alt="Event photo">`; })}
            </div>
          </div>
        </section>
      </section>
